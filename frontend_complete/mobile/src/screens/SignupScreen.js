    ...
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.screen}>
      <ScrollView contentContainerStyle={styles.content}>
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>Cree ton compte mobile et garde ta session sur l'app.</Text>
          ...
          <View style={styles.form}>
            ...
            <PrimaryButton title="J'ai deja un compte" variant="ghost" onPress={() => navigation.navigate("Login")} />
          </View>
        </View>
      </ScrollView>
