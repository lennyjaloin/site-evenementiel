  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <footer className="border-t border-white/5">
        <div className="container-app py-8 text-sm text-neutral-300 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3">
          ...
          <div className="opacity-70 text-xs sm:text-sm text-center">React + Tailwind • Framer Motion • BTS SIO</div>
        </div>
      </footer>
    </div>
  );
